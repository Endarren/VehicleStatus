...
-- ==============================================================Ulduar =================================================================
-- ======================================================================================================================================
vehicleIDs[33060] = {name = L["Salvaged Siege Engine"],					type = "Engine",	side = "Every"}
vehicleIDs[33067] = {name = L["Salvaged Siege Turret"],					type = "Turret",	side = "Every",			basenum = 	33060}
vehicleIDs[33167] = {name = L["Salvaged Demolisher Mechanic Seat"],		type = "Turret",	side = "Every",			basenum = 	33109}
vehicleIDs[33109] = {name = L["Salvaged Demolisher"],					type = "Demo",		side = "Every"}
vehicleIDs[33062] = {name = L["Salvaged Chopper"],						type = "Bike",		side = "Every"}
-- ======================================================================================================================================
-- ===========================================================Wintergrasp================================================================
-- ======================================================================================================================================
vehicleIDs[28319] = {name = L["Wintergrasp Siege Turret"],				type = "Turret",	side = "Alliance",		basenum = 	28312}
vehicleIDs[32629] = {name = L["Wintergrasp Siege Turret"],				type = "Turret",	side = "Horde",			basenum = 32627}
vehicleIDs[32627] = {name = L["Wintergrasp Siege Engine"],				type = "Engine",	side = "Horde"}
vehicleIDs[28312] = {name = L["Wintergrasp Siege Engine"],				type = "Engine",	side = "Alliance"}
vehicleIDs[28094] = {name = L["Wintergrasp Demolisher"],				type = "Demo",		side = "Every"}
vehicleIDs[27881] = {name = L["Wintergrasp Catapult"],					type = "Cata",		side = "Every"}
vehicleIDs[28366] = {name = L["Wintergrasp Tower Cannon"],				type = "Cannon",	side = "Every"}
-- ======================================================================================================================================
-- ======================================================Strand of the Ancients =========================================================
-- ======================================================================================================================================
vehicleIDs[28781] = {name = L["Battleground Demolisher"],				type = "Demo",		side = "Every"}
vehicleIDs[27894] = {name = L["Antipersonnel Cannon"],					type = "Cannon",	side = "Alliance"}
-- ======================================================================================================================================
-- =========================================================Isle of Conquest ============================================================	
-- ======================================================================================================================================
vehicleIDs[34775] = {name = L["Demolisher"],							type = "Demo",		side = "Every"}
vehicleIDs[34793] = {name = L["Catapult"],								type = "Cata",		side = "Every"}
vehicleIDs[34802] = {name = L["Glaive Thrower"],						type = "Cata",		side = "Alliance"}
vehicleIDs[35273] = {name = L["Glaive Thrower"],						type = "Cata",		side = "Horde"}
vehicleIDs[36356] = {name = L["Flame Turret"],							type = "Turret",	side = "Horde",			basenum = 35069}
vehicleIDs[34778] = {name = L["Flame Turret"],							type = "Turret",	side = "Alliance",		basenum = 34776}
vehicleIDs[36355] = {name = L["Siege Turret"],							type = "Turret",	side = "Horde",			basenum =35069 }
vehicleIDs[34777] = {name = L["Siege Turret"],							type = "Turret",	side = "Alliance",		basenum = 34776}
vehicleIDs[34929] = {name = L["Alliance Gunship Cannon"],				type = "Cannon",	side = "Alliance"}
vehicleIDs[34935] = {name = L["Horde Gunship Cannon"],					type = "Cannon",	side = "Horde"}
vehicleIDs[34944] = {name = L["Keep Cannon"],							type = "Cannon",	side = "Every"}
vehicleIDs[35069] = {name = L["Siege Engine"],							type = "Engine",	side = "Horde"}
vehicleIDs[34776] = {name = L["Siege Engine"],							type = "Engine",	side = "Alliance"}
-- ======================================================================================================================================
-- ============================================================Tol Barad=================================================================
-- ======================================================================================================================================
vehicleIDs[45344] = {name = L["Abandoned Siege Engine"],				type = "Engine",	side = "Every"}
vehicleIDs[48283] = {name = L["Wellson Cannon"],						type = "Cannon",	side = "Every"}
-- ======================================================================================================================================
-- =============================================================Icecrown ================================================================
-- ======================================================================================================================================
vehicleIDs[32227] = {name = L["Skybreaker Suppression Turret"],			type = "Turret",	side = "Alliance"}
vehicleIDs[31884] = {name = L["Kor'kron Suppression Turret"],			type = "Turret",	side = "Horde"}
vehicleIDs[31736] = {name = L["Geargrinder's Jumpbot"],					type = "Cata",		side = "Alliance"}
vehicleIDs[31770] = {name = L["Thunderbomb's Jumpbot"],					type = "Cata",		side = "Horde"}
-- ======================================================================================================================================
-- ===============================================================ICC ===================================================================
-- ======================================================================================================================================
vehicleIDs[36839] = {name = L["Horde Gunship Cannon"],					type = "Cannon",	side = "Horde"}
vehicleIDs[36838] = {name = L["Alliance Gunship Cannon"],				type = "Cannon",	side = "Alliance"}
		...
		if UnitHasVehicleUI(unit) then
			if vehicleName ~= nil then
				...
				if vehicleIDs[vehicleID].type ~= "Turret" then
					...
					VehicleStatus:AddPerson(spawnCounter, unit)
				else
...
function VehicleStatus:AddPerson(vehID, unit)
--Find their seat.
...
function VehicleStatus:RemovePerson(vehID,unit)
	for i=1,vehicleRoster[vehID].numseats do
